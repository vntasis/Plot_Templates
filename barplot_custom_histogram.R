...
distance_binned <- .bincode(distance, c(7000,10000,50000,100000,200000,500000,1e+6,10e+6, 40e+6), include.lowest=T)
...
# Axes titles
title(ylab="Frequency (Number of Enhancer - Gene Pairs)", line=5.5, cex.lab=2);
title(xlab="Enhancer - TSS distance", line=8, cex.lab=2);

# X axis labels adjustment
text(x = x+0.3, y = par("usr")[3] - 0.45,
    labels = c("7 - 10 kb", "10 - 50 kb", "50 - 100 kb", "100 - 200 kb", "200 - 500 kb", "0.5 - 1 Mb", "1 - 10 Mb", "10 - 40 Mb"),
